...
export default function Dashboard_Skeleton() {
  ...
  "
    ...
    "
      ...
      "
          >
            <Skeleton className=" h-96 w-[20px] py-2" />
          </div>
        </div>
        <div
          className="
    text-center bg-gray-300 text-white w-[90%] h-[200px] py-2 rounded-lg my-4
    sm:text-center sm:bg-gray-300 sm:text-white sm:w-[80%] sm:h-[230px] sm:py-3 sm:rounded-lg sm:my-4
    md:text-center md:bg-gray-300 md:text-white md:w-[70%] md:h-[260px] md:py-4 md:rounded-lg md:my-4
    lg:text-center lg:bg-gray-300 lg:text-white lg:w-[60%] lg:h-[290px] lg:py-5 lg:rounded-lg lg:my-4
    xl:text-center xl:bg-gray-300 xl:text-white xl:w-[80%] xl:h-[310px] xl:py-8 xl:rounded-lg xl:my-4
    2xl:text-center 2xl:bg-gray-300 2xl:text-white 2xl:w-[70%] 2xl:h-[320px] 2xl:py-8 2xl:rounded-lg
    "
        >
          <p
            className="
    ...
    "
        >
          <div
            className="
      text-center bg-gray-300 text-[white] w-[90%] h-[80px] p-4 rounded-lg
      sm:text-center sm:bg-gray-300 sm:text-[white] sm:w-[80%] sm:h-[80px] sm:p-4 sm:rounded-lg
      md:text-center md:bg-gray-300 md:text-[white] md:w-[70%] md:h-[80px] md:p-4 md:rounded-lg
      lg:text-center lg:bg-gray-300 lg:text-[white] lg:w-[60%] lg:h-[80px] lg:p-4 lg:rounded-lg
      xl:text-center xl:bg-gray-300 xl:text-[white] xl:w-[90%] xl:h-[80px] xl:p-4 xl:rounded-lg
      2xl:text-center 2xl:bg-gray-300 2xl:text-[white] 2xl:w-[90%] 2xl:h-[90px] 2xl:p-4 2xl:mx-4 2xl:rounded-lg
      "
          >
      ...
      "
          ...
          <div
            className="
        text-center bg-gray-300 text-white w-[90%] h-[80px] p-4 rounded-lg mt-4
        sm:text-center sm:bg-gray-300 sm:text-white sm:w-[80%] sm:h-[80px] sm:p-4 sm:rounded-lg sm:mt-4
        md:text-center md:bg-gray-300 md:text-white md:w-[70%] md:h-[80px] md:p-4 md:rounded-lg md:mt-4
        lg:text-center lg:bg-gray-300 lg:text-white lg:w-[60%] lg:h-[80px] lg:p-4 lg:rounded-lg lg:mt-4
        xl:text-center xl:bg-gray-300 xl:text-white xl:w-[90%] xl:h-[80px] xl:p-4 xl:rounded-lg xl:mt-4
        2xl:mt-6 2xl:text-center 2xl 2xl:text-white 2xl:w-[90%] 2xl:h-[90px] 2xl:p-4 2xl:mx-4 2xl:rounded-lg
        "
          >
            <Skeleton
              className="
            ...
            lg:mt-2 lg:text-2xl lg:font-bold
            xl:mt-2 xl:text-2xl xl:font-bold
            2xl:mt-2 2xl:w-auto 2xl:h-8 2xl:font-bold
            "
            />
          </div>
        </div>
