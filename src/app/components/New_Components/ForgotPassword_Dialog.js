    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                ...
                xl:border-none xl:ml-[77%] xl:mt-6 xl:text-xl xl:w-auto xl:[text-decoration:underline] xl:inline-block xl:text-[#FF7E7E] xl:cursor-pointer
                2xl:border-none 2xl:ml-[77%] 2xl:mt-6 2xl:text-xl 2xl:w-auto 2xl:[text-decoration:underline] 2xl:inline-block 2xl:text-[#FF7E7E] 2xl:cursor-pointer
