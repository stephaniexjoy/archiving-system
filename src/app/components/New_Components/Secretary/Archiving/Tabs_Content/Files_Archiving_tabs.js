...
export default function Files_Archiving_tabs({ children, dataWithFormattedDate }) {
   ...
   const [openInstructor, setOpenInstructor] = React.useState(false)
    ...
    const [openFiletype, setOpenFiletype] = React.useState(false)
    const [valueFiletype, setValueFiletype] = React.useState("") 
    return (
        <>
                ...
                <div className="dropdown">
                    <Popover open={openMaterial} onOpenChange={setOpenMaterial}>
                        <PopoverTrigger asChild>
                            ...
                            >
                                {valueMaterial
                                    ? materialFrameworks.find((framework) => framework.value === valueMaterial)?.label
                                    : "Select material..."}
                                    ...
                                    {materialFrameworks.map((framework) => (
                                        ...
                                        >
                                            ...
                                            <CheckIcon
                                                className={cn(
                                                    "ml-auto h-4 w-4",
                                                    valueMaterial === framework.value ? "opacity-100" : "opacity-0"
                                                )}
                                            />
                                        </CommandItem>
                                    ))}
                ...
                <div className="dropdown">
                    <Popover open={openProgram} onOpenChange={setOpenProgram}>
                        <PopoverTrigger asChild>
                            ...
                            >
                                {valueProgram
                                    ? programFrameworks.find((framework) => framework.value === valueProgram)?.label
                                    : "Select program..."}
                                <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                            </Button>
                        </PopoverTrigger>
                                ...
                                <CommandGroup>
                                    {programFrameworks.map((framework) => (
                                        <CommandItem
                                            ...
                                            value={framework.value}
                                            onSelect={(currentValue) => {
                                                setValueProgram(currentValue === value ? "" : currentValue)
                                        ...
                                        >
                                            ...
                                            <CheckIcon
                                                className={cn(
                                                    "ml-auto h-4 w-4",
                                                    valueProgram === framework.value ? "opacity-100" : "opacity-0"
                                                )}
                                            />
                                        </CommandItem>
                                    ))}
                ...
                <div className="dropdown">
                    <Popover open={openInstructor} onOpenChange={setOpenInstructor}>
                        <PopoverTrigger asChild>
                            ...
                            >
                                {valueInstructor
                                    ? instructorFrameworks.find((framework) => framework.value === valueInstructor)?.label
                                    : "Select instructor..."}
                                <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                            </Button>
                        </PopoverTrigger>
                                ...
                                <CommandGroup>
                                    {instructorFrameworks.map((framework) => (
                                        <CommandItem
                                            ...
                                            value={framework.value}
                                            onSelect={(currentValue) => {
                                                setValueInstructor(currentValue === value ? "" : currentValue)
                                        ...
                                        >
                                            ...
                                            <CheckIcon
                                                className={cn(
                                                    "ml-auto h-4 w-4",
                                                    valueInstructor === framework.value ? "opacity-100" : "opacity-0"
                                                )}
                                            />
                                        </CommandItem>
                                    ))}
                ...
                <div className="dropdown">
                    <Popover open={openFiletype} onOpenChange={setOpenFiletype}>
                        <PopoverTrigger asChild>
                            ...
                            >
                                {valueFiletype
                                    ? filetypeFrameworks.find((framework) => framework.value === valueFiletype)?.label
                                    : "Select File Type..."}
                                <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                            </Button>
                        </PopoverTrigger>
                                ...
                                <CommandGroup>
                                    {filetypeFrameworks.map((framework) => (
                                        <CommandItem
                                            ...
                                            value={framework.value}
                                            onSelect={(currentValue) => {
                                                setValueFiletype(currentValue === value ? "" : currentValue)
                                        ...
                                        >
                                            ...
                                            <CheckIcon
                                                className={cn(
                                                    "ml-auto h-4 w-4",
                                                    valueFiletype === framework.value ? "opacity-100" : "opacity-0"
                                                )}
                                            />
                                        </CommandItem>
                                    ))}
