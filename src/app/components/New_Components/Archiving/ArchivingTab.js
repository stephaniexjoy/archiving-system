  ...
  if (status === "authenticated") {
    ...
    return (
      <Tabs defaultValue="files" className="w-full">
        ...
        <TabsContent value="assignedtask"> <AssignedTask_Archiving_tabs position={session.user.position} tasks={filteredTasks} materials={materials} courses={courses}/> </TabsContent>
