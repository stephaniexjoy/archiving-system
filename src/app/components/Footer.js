...
const Footer = () => {
  return (
    <footer className="bg-[#AD5606] px-4 md:px-10 h-[30%]">
      <div className="flex flex-row md:flex-row">
        <div className="flex flex-col md:flex-col md:w-1/2">
          ...
          <div className="flex flex-col md:flex-row w-full md:w-1/2">
            <div className="w-full md:w-1/2 flex flex-col items-start justify-start -mt-[14%]">
              ...
              <div className="flex flex-col">
                <div className="flex items-start justify-start mb-2">
                  ...
                  <p className="ml-1 text-white font-semibold">(049) 554-3033</p>
                </div>
                <div className="flex items-start justify-start mb-2">
                  <img src="/photos/emailLogo.png" alt="Email Logo" className="w-7 h-auto" />
                  <p className="ml-1 text-white font-semibold">ccs_spc@lspu.edu.ph</p>
                </div>
                <div className="flex items-start justify-start">
                  <img src="/photos/locationLogo.png" alt="Location Logo" className="w-7 h-auto" />
                  <p className="ml-1 text-white font-semibold">Brgy. Del Remedio, San Pablo City, Philippines</p>
                </div>
              </div>
            </div>
          </div>
