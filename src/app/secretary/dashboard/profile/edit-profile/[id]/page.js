    ...
    <div className="flex flex-auto w-auto h-screen">
      <div className="flex flex-col w-full h-screen items-center">
        ...
        <div className="border m-4 bg-[#AD5606] w-auto h-[85%] rounded-lg shadow-lg">
          <form
            action={updateUser}
            className=" w-auto h-[93%] bg-[#DABB9C] rounded-3xl shadow m-6 overflow-scroll overflow-x-hidden"
          >
            <div className="m-5">
              <div className="flex flex-row gap-x-10 justify-center ">
                ...
                <div className="basis-2/4">
                  <input
                    ...
                    name="updName"
                    placeholder=""
                    className="mt-10 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#242323] bg-[#D9D9D9] inline-block w-[full] md:w-[800px] h-[35px] md:text-shadow-inner"
                  />
                  <input
                    type="text"
                    name="updPosition"
                    placeholder=""
                    className="mt-5 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#242323] bg-[#D9D9D9] inline-block w-[full] md:w-[800px] h-[35px] md:text-shadow-inner"
                  />
                  <input
                    type="text"
                    name="updDesignation"
              ...
              <div className="flex flex-row gap-x-8 text-[#000000]">
                <div className="basis-1/4">
                  <p className="mt-10 text-[14px] md:text-[23px]">School:</p>
                  <p className="mt-5 text-[14px] md:text-[23px]">
                    Specialization:
                  </p>
                  <p className="mt-5 text-[14px] md:text-[23px]">
                ...
                <div className="">
                  <input
                    ...
                    name="updSchool"
                    placeholder=""
                    className="mt-10 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#000000] bg-[#D9D9D9] inline-block w-[full] md:w-[1198px] h-[35px] md:text-shadow-inner"
                  />
                  <input
                    type="text"
                    name="updSpec"
                    placeholder=""
                    className="mt-5 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#000000] bg-[#D9D9D9] inline-block w-[full] md:w-[1198px] h-[35px] md:text-shadow-inner"
                  />
                  <input
                    type="text"
                    name="updCert"
                    placeholder=""
                    className="mt-5 mb-5 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#000000] bg-[#D9D9D9] inline-block w-[full] md:w-[1198px] h-[35px] md:text-shadow-inner"
                  />
                </div>
              </div>
              <div>
                <h2 className="md:text-[20px] text-bold font-bold uppercase text-center">
                ...
                <div className="flex flex-row gap-x-10 text-[#000000]">
                  ...
                  <div className="">
                    <input
                      ...
                      name="updBacDeg"
                      placeholder=""
                      className="mt-10 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#242323] bg-[#D9D9D9] inline-block w-[full] md:w-[500px] h-[35px] md:text-shadow-inner"
                    />
                    <input
                      type="text"
                      name="updMasDeg"
                  ...
                  <div className="">
                    <input
                      ...
                      name="updBacDegSchl"
                      placeholder=""
                      className="mt-10 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#242323] bg-[#D9D9D9] inline-block w-[full] md:w-[550px] h-[35px] md:text-shadow-inner"
                    />
                    <input
                      type="text"
                      name="updMasDegSchl"
                  ...
                  <div className="mt-10 flex grid-cols-2 space-x-40 justify-center text-[#000000] font-bold font-[Times New Roman]">
                    <div className=" text-center ">
                      ...
                      <div>
                        <textarea
                          name="seminarsUpd"
                          className="mt-5 overflow-auto top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#242323] bg-[#D9D9D9] inline-block w-[full] md:w-[400px] h-[90px] md:text-shadow-inner"
                        ></textarea>
                      </div>
                    ...
                    <div className="text-center">
                      ...
                      <div>
                        <textarea
                          name="papersUpd"
                          className="mt-5 top-[125px] left-[10px] md:left-[430px] text-md md:text-xl text-[#242323] bg-[#D9D9D9] inline-block w-[full] md:w-[400px] h-[90px] md:text-shadow-inner"
                        ></textarea>
                      </div>
                      <div className="mt-10 font-bold">
