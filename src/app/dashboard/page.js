  ...
  return (
    <div className="flex flex-col w-auto h-full">
      ...
      <div className="flex mt-[2%] px-10">
        ...
        <img
          className="h-[50%] w-[90%] mt-[1%] ml-[3%] sm:w-[80%] sm:h-[40%] md:w-[80%] md:h-[40%] lg:w-[80%] lg:h-[40%]"
          alt="Filler"
          src="../photos/Filler.png"
        />
        <img
          className="h-[70%] w-[90px] mt-[.8%] ml-[2%] sm:w-[50%] sm:h-[50%] md:w-[60%] md:h-[50%] lg:w-[20%] lg:h-[50%]"
