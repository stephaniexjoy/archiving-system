          ...
          >
            ...
            >
              <Card
                ...
                2xl:flex 2xl:flex-col 2xl:mt-6 2xl:ml-0 2xl:p-4 2xl:gap-0 2xl:drop-shadow-2xl 2xl:rounded-xl 2xl:w-[70%] 2xl:h-64
                "
              >
                <CardContent
                  className="
                ...
                <Dialog>
                  <DialogTrigger className=" flex text-xl mx-auto w-[80%] sm:w-[70%] 2xl:w-[60%] h-16 border bg-[#AD5606] hover:bg-gray-700 text-white font-bold rounded cursor-pointer items-center justify-center mt-4">
                    Upload Here
                  </DialogTrigger>
                ...
                <button
                  ...
                  //   console.log(fileInfo);
                  // }}
                  className="flex mx-auto w-[80%] sm:w-[70%] 2xl:w-[60%] h-16 border bg-[#AD5606] hover:bg-gray-800 text-white font-bold py-1 px-4 rounded my-2 cursor-pointer items-center justify-center"
                >
                  Mark as done  
                </button>
                </Card>
