      ...
      <div className="bg-[#F5EEE6] overflow-scroll overflow-x-hidden ml-4 w-full md:w-3/4 lg:w-3/3 xl:w-3/4 2xl:w-4/5 md:mx-24 h-full my-6 rounded-t-lg rounded-b-lg shadow-2xl">
        <div className="flex flex-row justify-center">
          ...
          <div className="ml-5 mt-7 sm:mt-7 md:mt-7 lg:mt-6 basis-3/5 font-semibold text-[9.5px] text-black text-lg sm:text-left lg:text-left md:text-left lg:w-[900px] h-[30px] sm:w-[700px] ">
            <div className=" sm:text-sm md:text-md lg:text-lg">Name: {user.name}</div>
        ...
        <div
          className="mt-[40px] sm:mt-[20px] md:mt-[5px] md:top-[290px] sm:top-[300px] lg:top-[290px] font-semibold text-[11.9px] bg-[#8F8F8F] [backdrop-filter:blur(4px)] text-lg text-white text-center sm:text-sm md:text-md lg:text-lg w-full h-[30px]  sm:w-full sm:h-[30px]  md:w-full md:h-[30px]">
        ...
        <div>
          ...
          <div>
            <table className="w-full border-none border-collapse">
              <thead>
                <tr>
                  <th className="border border-black bg-[#D7D4D4] [backdrop-filter:blur(4px)] font-semibold text-[11.9px] text-lg text-black text-center w-1/3 h-[30px]text-center sm:text-sm md:text-md lg:text-lg h-[30px]   sm:h-[30px]   md:h-[30px]">COMPLETED</th>
                  <th className="border border-black bg-[#D7D4D4] [backdrop-filter:blur(4px)] font-semibold text-[11.9px] text-lg text-black text-center w-1/3 h-[30px]text-center sm:text-sm md:text-md lg:text-lg h-[30px]   sm:h-[30px]   md:h-[30px]">PUBLISHED</th>
                  <th className="border border-black bg-[#D7D4D4] [backdrop-filter:blur(4px)] font-semibold text-[11.9px] text-lg text-black text-center w-1/3 h-[30px]text-center sm:text-sm md:text-md lg:text-lg h-[30px]   sm:h-[30px]    md:h-[30px]">PRESENTED</th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <div className="mt-0 top-[285px] bottom-[285px] font-semibold text-[20px] bg-[#FFFFFF] [backdrop-filter:blur(4px)] text-black text-center w-full h-[16px]">
            <div className="w-screen h-auto bg-cover flex">
              ...
              <div className="flex justify-center">
                <button type="button" className="bg-[#5B0505] text-[12px] text-white text-center inline-block w-[80px] h-[38px] [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)]  mt-10 ml-32  md:ml-20 sm:ml-20 lg:ml-96 sm:text-sm lg:w-[150px] sm:w-[100px] md:w-[140px]">
