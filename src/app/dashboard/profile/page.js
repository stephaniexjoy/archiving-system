...
export default async function profile() {
  ...
  return (
    <div className="flex items-center flex-col w-screen h-screen ">
      ...
      <div className="bg-[#F5EEE6] overflow-scroll overflow-x-hidden  sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl h-full my-6 rounded-t-lg rounded-b-lg shadow-2xl">
