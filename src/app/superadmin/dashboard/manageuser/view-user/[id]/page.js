        ...
        <div>
          ...
          <div>
            <table
              ...
              <thead>
                <tr>
                  <th className="border border-black bg-[#D7D4D4] backdrop-blur-[4px] font-semibold text-[20px] text-[#8F8F8F] text-center w-1/3 h-[30px]">
                    COMPLETED
                  </th>
                  <th className="border border-black bg-[#D7D4D4] backdrop-blur-[4px] font-semibold text-[20px] text-[#8F8F8F] text-center w-1/3 h-[30px]">
                    PUBLISHED
              ...
              <tbody>
                <tr>
                  <td className="border border-black text-white text-center h-[50px]"></td>
                  <td className="border border-black text-white text-center h-[50px]"></td>
                  <td className="border border-black text-white text-center h-[50px]"></td>
                </tr>
                <tr>
