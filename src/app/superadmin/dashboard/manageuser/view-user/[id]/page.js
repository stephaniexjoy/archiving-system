            ...
            <div className="bg-[#F5EEE6] overflow-scroll overflow-x-hidden md:mx-40 max-w-screen-sm  md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl h-full rounded-t-lg rounded-b-lg shadow-2xl">
                <div className="flex flex-row justify-center">
                    ...
                    <div className="ml-28 basis-2/5 font-semibold text-black sm:text-sm md:text-md lg:text-lg">
                        <div className=" mt-6 top-[350px]">Designation: {user.designation}</div>
                        <div >Specialization: {user.specialization}</div>
                        <div >Certifications: {user.certifications}</div>
                    </div>
                </div>
                <div
                    className="mt-5 top-[290px] font-semibold sm:text-sm md:text-md lg:text-lg bg-[#8F8F8F] [backdrop-filter:blur(4px)] text-white text-center max-w-screen-sm  md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
                ...
                <div>
                    ...
                    <div>
                        <table className="w-full border-none border-collapse">
                            <thead>
                                <tr>
                                    <th className="border border-black bg-[#D7D4D4] font-semibold sm:text-sm md:text-md lg:text-lg text-white text-center">COMPLETED</th>
                                    <th className="border border-black bg-[#D7D4D4] font-semibold sm:text-sm md:text-md lg:text-lg text-white text-center">PUBLISHED</th>
                                    <th className="border border-black bg-[#D7D4D4] font-semibold sm:text-sm md:text-md lg:text-lg text-white text-center">PRESENTED</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                ...
                <div className="mb-5 w-screen h-auto flex place-content-center space-x-20">
                    ...
                    <div className="flex justify-center">
                        <button type="submit" className="bg-[#5B0505] text-[12px] text-white text-center inline-block w-[100px] h-[38px] [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)] lg:w-[180px] sm:w-[140px] md:w-[160px]">
                            BACK
                        </button>
                    </div>
                    <div className="flex justify-center">
